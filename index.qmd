...
- Qi, J.$^\dagger$, **Sarti, G.**$^\dagger$, Fernández, R. and Bisazza, A. [-@qi-etal-2024-model]. Model Internals-based Answer Attribution for Trustworthy Retrieval-Augmented Generation. In *Proceedings of the 2024 Conference on Empirical Methods in Natural Language Processing (EMNLP)* (**Chapter 5**)
