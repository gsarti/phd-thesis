...
- **Sarti, G.**, Chrupała G., Nissim, M. and Bisazza, A. [-@sarti-etal-2024-quantifying]. Quantifying the Plausibility of Context Reliance in Neural Machine Translation. In *Proceedings of the 12th International Conference on Learning Representations (ICLR)* (**@sec-chap-4-pecore**)

- Qi, J.$^\dagger$, **Sarti, G.**$^\dagger$, Fernández, R. and Bisazza, A. [-@qi-sarti-etal-2024-model]. Model Internals-based Answer Attribution for Trustworthy Retrieval-Augmented Generation. In *Proceedings of the 2024 Conference on Empirical Methods in Natural Language Processing (EMNLP)* (**@sec-chap-5-mirage**)
...
Open-source contributions play a fundamental role in my research efforts. Throughout the main contributions detailed above, I strived to make all datasets, methods and code publicly available, and well-documented to facilitate further research and reproducibility. In particular, I led the development of the **Inseq** toolkit presented in @sec-chap-3-inseq.
