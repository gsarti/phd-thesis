...
The [DivEMT]{.smallcaps} study in @sec-chap-8-divemt provides a nuanced answer to this question. While access to MT generally improves translator productivity, its contribution varies dramatically by language pair. In our results, typological similarity emerges as an important factor: languages closely related to the source language English, such as Dutch and Italian showed substantial post-editing productivity gains, while distant pairs like English-Arabic and English-Vietnamese saw minimal improvement even after controlling for training data resourcedness.
