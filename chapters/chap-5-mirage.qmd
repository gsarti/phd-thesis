...
In the next part of this thesis, we will move beyond analysis-driven methods to study how prompting (@sec-chap-6-ramp) and interpretability-based method (@sec-chap-7-sae-litmt) can be used to effectively condition the machine translation generation process.